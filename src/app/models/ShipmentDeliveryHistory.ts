import { LadingScheduleDeliveryHistory } from "../view-model/ladingScheduleDeliveryHistory.viewModel";

export class ShipmentDeliveryHistory implements LadingScheduleDeliveryHistory {
    id: number;
