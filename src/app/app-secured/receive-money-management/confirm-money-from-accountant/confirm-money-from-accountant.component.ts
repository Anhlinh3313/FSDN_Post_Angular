...
@Component({
  selector: "app-confirm-money-from-accountant",
  templateUrl: "confirm-money-from-accountant.component.html",
  styles: []
})
export class ConfirmMoneyFromAccountantComponent extends BaseComponent
  implements OnInit {
  txtFilterGb: any;
  constructor(
  ...
  currentPage: string = Constant.pages.receiptMoney.children
    .comfirmMoneyFromAccountant.name;
