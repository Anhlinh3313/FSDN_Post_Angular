...
import { ArrayHelper } from "../../../../infrastructure/array.helper";
  ...
  @Component({
    selector: "total-delivery",
    templateUrl: "total-delivery.component.html",
    styles: [],
    providers: [CustomerService, ProvinceService, DistrictService, WardService, HubService, ReasonService],
  })
  export class TotalDeliveryComponent extends BaseComponent
    implements OnInit {
    ...
    loadShipment() {
      ...
      shipmentFilterViewModel.Type = ShipmentTypeHelper.delivery;
