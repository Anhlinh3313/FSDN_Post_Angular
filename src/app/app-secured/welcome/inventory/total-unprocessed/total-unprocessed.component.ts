...
import { ArrayHelper } from "../../../../infrastructure/array.helper";
  ...
  @Component({
    selector: "total-unprocessed",
    templateUrl: "total-unprocessed.component.html",
    styles: [],
    providers: [CustomerService, ProvinceService, DistrictService, WardService, HubService, ReasonService],
  })
  export class TotalUnprocessedComponent extends BaseComponent
    implements OnInit {
    ...
    loadShipment() {
      ...
      shipmentFilterViewModel.Type = ShipmentTypeHelper.inventory;
