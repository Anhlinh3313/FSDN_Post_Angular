...
import { ArrayHelper } from "../../../../infrastructure/array.helper";
  ...
  @Component({
    selector: "total-transfer-pofrom",
    templateUrl: "total-transfer-pofrom.component.html",
    styles: [],
    providers: [CustomerService, ProvinceService, DistrictService, WardService, HubService, ReasonService],
  })
  export class TotalTransferPOFromComponent extends BaseComponent
    implements OnInit {
    ...
    loadShipment() {
      ...
      shipmentFilterViewModel.Type = ShipmentTypeHelper.transferring;
