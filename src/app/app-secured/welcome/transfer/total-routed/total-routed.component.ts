...
import { Router } from "@angular/router";
  ...
  @Component({
    selector: "total-routed",
    templateUrl: "total-routed.component.html",
    styles: [],
    providers: [CustomerService, ProvinceService, DistrictService, WardService, HubService, ReasonService],
  })
  export class TotalRoutedComponent extends BaseComponent
    implements OnInit {
    ...
    loadShipment() {
      ...
      const fromDate = "2016/01/01 00:00:00";
      this.shipmentService.getTransferHistory(fromDate, toDate)
        .subscribe(x => {
