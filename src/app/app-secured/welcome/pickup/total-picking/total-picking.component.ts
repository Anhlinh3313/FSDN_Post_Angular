...
@Component({
  selector: "total-picking",
  templateUrl: "total-picking.component.html",
  styles: [
    `
          agm-map {
            height: 200px;
...
export class TotalPickingComponent extends BaseComponent implements OnInit {
  txtFilterGb: any;
  ...
  loadShipment() {
    ...
    this.requestShipmentService
      .getByType(ShipmentTypeHelper.picking, includes)
      .subscribe(x => {
