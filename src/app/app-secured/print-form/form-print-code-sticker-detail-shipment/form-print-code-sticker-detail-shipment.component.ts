...
@Component({
    selector: 'form-print-code-sticker-detail-shipment',
    templateUrl: 'form-print-code-sticker-detail-shipment.component.html'
})

export class FormPrintCodeStickerDetailShipmentComponent extends PrintHelper implements OnInit {
    constructor(
