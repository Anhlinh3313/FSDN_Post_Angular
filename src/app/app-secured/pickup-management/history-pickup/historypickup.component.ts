...
@Component({
  selector: "app-histoty-pickup",
  templateUrl: "historypickup.component.html",
  styles: [
    `    
...
export class HistoryPickupComponent extends BaseComponent implements OnInit {
  hub = environment;
  ...
  currentPage: string = Constant.pages.pickup.children.historyPickup.name;
  modalTitle: string;
  bsModalRef: BsModalRef;
  displayDialog: boolean;
  selectedData: RequestShipment[];
  listData: RequestShipment[] = [];
  //
  columns: string[] = [
    "shipmentNumber",
    "shipmentStatusName",
  ...
  loadShipment() {
    this.requestShipmentService
      ...
      .subscribe(x => {
        ...
        this.datasource = x.data as RequestShipment[];
