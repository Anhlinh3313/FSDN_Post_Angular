...
@Component({
  selector: "app-report-cod",
  templateUrl: "report-cod.component.html",
  styles: []
})
export class ReportCodComponent extends BaseComponent implements OnInit {
  txtFilterGbLeft: any;
  constructor(
  ...
  currentPage: string = Constant.pages.report.children.reportCod.name;
  modalTitle: string;
