...
@Component({
    selector: 'report-postage-by-customer',
    templateUrl: './report-postage-by-customer.component.html',
    styles: []
})

export class ReportPostAgeByCustomerComponent extends BaseComponent implements OnInit {
    parentPage: string = Constant.pages.report.name;
    currentPage: string = Constant.pages.report.children.ReportPostAgeByCustomer.name;
    constructor(
