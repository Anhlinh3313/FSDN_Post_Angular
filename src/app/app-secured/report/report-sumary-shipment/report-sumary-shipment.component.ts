...
import { UserService, ShipmentService, HubService, ReportService, ServiceDVGTService, CustomerService, ServiceService, PaymentTypeService, ShipmentStatusService, UploadService } from '../../../services';
...
@Component({
  selector: 'app-report-sumary-shipment',
  templateUrl: './report-sumary-shipment.component.html',
  styles: []
})
export class ReportSumaryShipmentComponent extends BaseComponent implements OnInit {
    allHubs: SelectModel[] = [];
    ...
    columnsExp: any[] = [
        ...
        { field: "orderDate", header: 'Giờ VĐ',typeFormat: "time", formatString: 'HH:mm' },
        { field: "endPickTime", header: 'Ngày nhập kho lấy hàng', typeFormat: "date", formatString: 'dd/MM/yyyy' },
        { field: "endPickTime", header: 'Giờ nhập kho lấy hàng', typeFormat: "time", formatString: 'HH:mm' },
        { field: "timeCompareEndPickupTime", header: 'Thời gian(h) tính từ khi vận đơn đến nhập kho lấy hàng' },
        { field: "inOutDate", header: 'Ngày xuất/nhập cuối', typeFormat: "date", formatString: 'dd/MM/yyyy' },
        { field: "inOutDate", header: 'Giờ xuất/nhập cuối', typeFormat: "time", formatString: 'HH:mm' },
        { field: "endDeliveryTime", header: 'Ngày giao hàng thanh công', typeFormat: "date", formatString: 'dd/MM/yyyy' },
        { field: "endDeliveryTime", header: 'Giờ giao hàng thanh công', typeFormat: "time", formatString: 'HH:mm' },
        { field: "timeCompareString", header: 'Thời gian (h) từ khi xuất cuối đến khi giao hàng thành công' },
        { field: "timeCompareEndDeliveryTime", header: 'Tổng thời gian tính từ khi vận đơn đến khi giao thành công(h)' },
        { field: "deadlineDeliveryTime", header: 'Thời gian quy định giao hang' },
        ...
        { field: "timeCompareReceiptMoney", header: 'Thời gian nộp tiền(Tính từ khi giao thành công đến khi nộp thành công)'  },
    ...
    async exportCSVNew(dt: any) {
        if (dt) {
            let fileName = "BAO_CAO_TONG_HOP_DON_HANG";
