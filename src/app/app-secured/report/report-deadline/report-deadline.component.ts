...
@Component({
    selector: 'app-report-deadline',
    templateUrl: 'report-deadline.component.html',
    styles: []
})
export class ReportDeadlineComponent extends BaseComponent implements OnInit {
    hub = environment;
    ...
    constructor(
        ...
        private serviceSevice: ServiceService
    ) {
    ...
    currentPage: string = Constant.pages.report.children.reportDeadline.name;
    //
    customer: any;
    customerChange: any;
    ...
    async loadShipment() {
        let results = await this.reportService.getReportDeadline(this.fromDate, this.toDate, this.fromProvinceId, this.toProvinceId, this.fromHubId, this.toHubId, this.deliveryUserId, this.senderId, this.selectedService).toPromise();
