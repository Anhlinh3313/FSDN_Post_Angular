...
@Component({
  ...
  templateUrl: "list-delivery-complete.component.html",
  styles: [
    `
      agm-map {
        height: 200px;
...
export class ListDeliveryCompleteComponent extends BaseComponent
  implements OnInit {
  ...
  loadShipment() {
    ...
    shipmentFilterViewModel.Type = ShipmentTypeHelper.deliveryComplete;
