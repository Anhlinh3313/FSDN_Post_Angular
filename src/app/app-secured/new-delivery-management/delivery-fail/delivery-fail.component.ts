...
import { ArrayHelper } from "../../../infrastructure/array.helper";
  ...
  export class DeliveryFailComponent extends BaseComponent
    implements OnInit {
    ...
    currentPage: string = Constant.pages.deliveryManagement.children.deliveryFail.name;
    modalTitle: string;
    ...
    loadShipment() {
      ...
      shipmentFilterViewModel.Type = ShipmentTypeHelper.deliveryFail;
