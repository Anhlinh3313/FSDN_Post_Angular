...
@Injectable()
export class ChargedCODService extends GeneralService {
  constructor(protected messageService: MessageService, protected httpClient: HttpClient, protected persistenceService: PersistenceService) {
    super(messageService, httpClient, persistenceService, environment.apiPostUrl, "chargedCOD");
  }
  ...
  public saveSetup(chargedCOD: ChargedRemote): Observable<ResponseModel> {
    return super.postCustomApi("SaveSetup", chargedCOD);
  }
